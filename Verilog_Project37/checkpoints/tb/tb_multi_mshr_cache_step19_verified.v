...
module tb_multi_mshr_cache;
    ...
    initial begin
        ...
        $display("STEP 19 - MEMORY RESPONSE OWNERSHIP INTEGRITY");
        $display("================================================");
        ...
        if (mshr_valid_debug == 4'b1011 &&
            ...
            $display("PASS: MSHR 2 released, MSHR 0/1/3 remain active");
            pass_count = pass_count + 1;
            ...
            $display(
                "FAIL: valid=%b addr0=%h addr1=%h addr3=%h",
                mshr_valid_debug,
                mshr_addr_debug[0],
                mshr_addr_debug[1],
                mshr_addr_debug[3]
         ...
         * ========================================================
         *
         * Verify that MSHR 2 response affected only its
         * corresponding cache line.
         */

        $display("");
        $display("TEST 4: Verify MSHR 2 refill");
        $display("Expected: 0x120 is CACHE HIT");
        ...
        if (req_class_debug == 2'b00 &&
            ...
            $display("PASS: 0x120 is a CACHE HIT");
            pass_count = pass_count + 1;
         ...
         * ========================================================
         *
         * Verify other outstanding requests were not accidentally
         * converted into cache hits.
         */

        $display("");
        $display("TEST 5: Verify other MSHRs remain outstanding");
        $display("Expected: 0x100 and 0x110 are DUPLICATE");
        ...
        if (req_class_debug == 2'b10 &&
            ...
            $display(
                "FAIL: 0x100 class=%b match=%b owner=%0d",
                req_class_debug,
                req_mshr_match_debug,
                req_mshr_index_debug
            );
        ...
        if (req_class_debug == 2'b10 &&
            ...
            $display("PASS: 0x110 remains owned by MSHR 1");
            pass_count = pass_count + 1;
            ...
            $display(
                "FAIL: 0x110 class=%b match=%b owner=%0d",
                req_class_debug,
                req_mshr_match_debug,
                req_mshr_index_debug
            );
        ...
        $display("Expected: only MSHR 1 remains active");
         ...
         * ========================================================
         *
         * All four completed addresses must now be cache hits.
         */

        $display("");
        $display("TEST 9: Verify all completed addresses are CACHE HITs");
        ...
        if (req_class_debug == 2'b00) begin
            ...
            $display("FAIL: 0x110 class=%b", req_class_debug);
            fail_count = fail_count + 1;
        end
        ...
        if (req_class_debug == 2'b00) begin
            ...
            $display("FAIL: 0x120 class=%b", req_class_debug);
            fail_count = fail_count + 1;
        end
        ...
        if (req_class_debug == 2'b00) begin
            $display("PASS: 0x130 is a CACHE HIT");
            pass_count = pass_count + 1;
        end
        else begin
            $display("FAIL: 0x130 class=%b", req_class_debug);
            fail_count = fail_count + 1;
        end
        ...
        $display("");
        $display("================================================");
        $display("PROJECT 37 STEP 19 VERIFICATION SUMMARY");
        $display("================================================");
        ...
        if (fail_count == 0) begin
            ...
            $display(
                "PROJECT 37 STEP 19 VERIFICATION: PASS"
            );
            ...
            $display(
                "PROJECT 37 STEP 19 VERIFICATION: FAIL"
            );
