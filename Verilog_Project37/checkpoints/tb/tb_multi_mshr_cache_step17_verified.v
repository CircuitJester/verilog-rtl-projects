...
module tb_multi_mshr_cache;
    ...
    initial begin
        ...
        $display("STEP 17 - MULTIPLE MSHR OWNER LOOKUP");
        $display("================================================");
         ...
         * ========================================================
         *
         * Allocate four independent outstanding requests.
         */
        ...
        $display("");
        $display("TEST 2: Verify all memory requests are issued");
        ...
        $display("");
        $display("TEST 3: Lookup owner of 0x100");
        ...
        $display("");
        $display("TEST 4: Lookup owner of 0x110");
        ...
        if (req_class_debug == 2'b10 &&
            ...
            $display("PASS: 0x110 owned by MSHR 1");
            pass_count = pass_count + 1;
        ...
        $display("");
        $display("TEST 5: Lookup owner of 0x120");
        $display("Expected: DUPLICATE / MSHR 2");
        ...
        $display("");
        $display("TEST 6: Lookup owner of 0x130");
        $display("Expected: DUPLICATE / MSHR 3");
         ...
         * ========================================================
         *
         * Unrelated address must not match any MSHR.
         */

        $display("");
        $display("TEST 7: Lookup unrelated address 0x140");
        $display("Expected: NEW MISS / no owner");
        ...
        if (req_class_debug == 2'b01 &&
            ...
            $display("PASS: 0x140 is NEW MISS with no owner");
            pass_count = pass_count + 1;
         ...
         * ========================================================
         *
         * Complete one MSHR and verify its ownership disappears.
         */

        $display("");
        $display("TEST 8: Complete MSHR 1");
        $display("Expected: 0x110 no longer has an owner");
        ...
        if (req_class_debug == 2'b00 &&
            ...
            $display("PASS: 0x110 became CACHE HIT after refill");
            pass_count = pass_count + 1;
         ...
         * ========================================================
         *
         * Other MSHR owners must remain intact.
         */

        $display("");
        $display("TEST 9: Verify remaining MSHR ownership");
        ...
        if (req_mshr_match_debug == 1'b1 &&
            req_mshr_index_debug == 2'd0) begin

            pass_count = pass_count + 1;
            $display("PASS: 0x100 still owned by MSHR 0");

        end
        else begin

            fail_count = fail_count + 1;
            $display("FAIL: 0x100 owner=%0d", req_mshr_index_debug);
        ...
        if (req_mshr_match_debug == 1'b1 &&
            ...
            pass_count = pass_count + 1;
            $display("PASS: 0x120 still owned by MSHR 2");

        end
        else begin

            fail_count = fail_count + 1;
            $display("FAIL: 0x120 owner=%0d", req_mshr_index_debug);
        ...
        if (req_mshr_match_debug == 1'b1 &&
            ...
            pass_count = pass_count + 1;
            $display("PASS: 0x130 still owned by MSHR 3");

        end
        else begin

            fail_count = fail_count + 1;
            $display("FAIL: 0x130 owner=%0d", req_mshr_index_debug);
        ...
        $display("");
        $display("================================================");
        $display("PROJECT 37 STEP 17 VERIFICATION SUMMARY");
        $display("================================================");
        ...
        if (fail_count == 0) begin
            ...
            $display(
                "PROJECT 37 STEP 17 VERIFICATION: PASS"
            );
            ...
            $display(
                "PROJECT 37 STEP 17 VERIFICATION: FAIL"
            );
