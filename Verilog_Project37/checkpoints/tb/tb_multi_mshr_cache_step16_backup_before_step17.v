...
module tb_multi_mshr_cache;
    ...
    initial begin
        ...
        $display("STEP 16 - MSHR HOLE REUSE");
        $display("================================================");
         ...
         * ========================================================
         *
         * Allow all four memory transactions to issue.
         */
         ...
         * ========================================================
         *
         * Release MSHR 2 while MSHR 0, 1 and 3 remain active.
         */

        $display("");
        $display("TEST 3: Create an MSHR hole");
        $display("Expected: MSHR 2 becomes free");

        complete_mshr(2, 32'hAAAA0120);

        #1;

        if (mshr_valid_debug == 4'b1011 &&
            mshr_addr_debug[0] == 32'h00000100 &&
            mshr_addr_debug[1] == 32'h00000110 &&
            mshr_addr_debug[3] == 32'h00000130) begin

            $display("PASS: MSHR 2 released while MSHR 0/1/3 remain active");
            pass_count = pass_count + 1;
            ...
            $display(
                "FAIL: hole creation state valid=%b",
                mshr_valid_debug
            );
         ...
         * ========================================================
         *
         * Submit a new miss while MSHR 0, 1 and 3 are active.
         *
         * First-free policy must select MSHR 2.
         */

        $display("");
        $display("TEST 4: Reuse released MSHR");
        $display("Expected: 0x140 allocated into MSHR 2");
        ...
        if (mshr_valid_debug == 4'b1111 &&
            ...
            $display("PASS: 0x140 reused MSHR 2");
            pass_count = pass_count + 1;
            ...
            $display(
                "FAIL: reuse state valid=%b addr0=%h addr1=%h addr2=%h addr3=%h",
                mshr_valid_debug,
                mshr_addr_debug[0],
                mshr_addr_debug[1],
                mshr_addr_debug[2],
         ...
         * ========================================================
         *
         * Verify the reused MSHR eventually generates a memory
         * request for the new address.
         */

        $display("");
        $display("TEST 5: Verify reused MSHR memory request");
        $display("Expected: MSHR 2 issues request for 0x140");
        ...
        if (mshr_valid_debug == 4'b1101) begin
        ...
        $display("");
        $display("TEST 7: Complete MSHR 3");
        ...
        if (mshr_valid_debug == 4'b0101) begin
        ...
        $display("Expected: only reused MSHR 2 remains");

        complete_mshr(0, 32'hAAAA0100);

        #1;

        if (mshr_valid_debug == 4'b0100) begin

            $display("PASS: only MSHR 2 remains active");
            pass_count = pass_count + 1;
         ...
         * ========================================================
         *
         * Complete reused MSHR 2.
         */

        $display("");
        $display("TEST 9: Complete reused MSHR 2");
        $display("Expected: all MSHRs released");

        complete_mshr(2, 32'hAAAA0140);
         ...
         * ========================================================
         *
         * Verify the newly reused address is now a cache hit.
         */

        $display("");
        $display("TEST 10: Verify reused address refill");
        $display("Expected: 0x140 is a CACHE HIT");
        ...
        $display("");
        $display("================================================");
        $display("PROJECT 37 STEP 16 VERIFICATION SUMMARY");
        $display("================================================");
        ...
        if (fail_count == 0) begin
            ...
            $display(
                "PROJECT 37 STEP 16 VERIFICATION: PASS"
            );
            ...
            $display(
                "PROJECT 37 STEP 16 VERIFICATION: FAIL"
            );
