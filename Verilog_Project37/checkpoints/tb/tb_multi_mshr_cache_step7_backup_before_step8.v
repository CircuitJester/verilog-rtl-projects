...
module tb_multi_mshr_cache;
    ...
    initial begin
        ...
        /*
         * ========================================================
         * STEP 7 INTERNAL CACHE INSPECTION
         * ========================================================
         */

        $display("");
        $display("===== INTERNAL CACHE STATE AFTER TEST 12 =====");
        $display("CACHE[0]: valid=%b tag=%h data=%h",
                 dut.cache_valid[0],
                 dut.cache_tag[0],
                 dut.cache_data[0]);

        $display("CACHE[1]: valid=%b tag=%h data=%h",
                 dut.cache_valid[1],
                 dut.cache_tag[1],
                 dut.cache_data[1]);

        $display("CACHE[2]: valid=%b tag=%h data=%h",
                 dut.cache_valid[2],
                 dut.cache_tag[2],
                 dut.cache_data[2]);

        $display("CACHE[3]: valid=%b tag=%h data=%h",
                 dut.cache_valid[3],
                 dut.cache_tag[3],
                 dut.cache_data[3]);
