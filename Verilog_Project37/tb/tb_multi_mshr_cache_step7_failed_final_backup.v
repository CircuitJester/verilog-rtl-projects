...
module tb_multi_mshr_cache;
    ...
    initial begin
         ...
         * ========================================================
         *
         * Establish the same cache/MSHR state used by the
         * verified Step 6 baseline.
         */
        ...
        if (!mshr_valid_debug[2] &&
            ...
            $display(
                "PASS: MSHR 2 released while others remain active"
            );
            ...
            $display(
                "FAIL: MSHR 2 release state incorrect"
            );
        ...
        if (!mshr_valid_debug[0] &&
            ...
            $display(
                "FAIL: MSHR 0 release state incorrect"
            );
        ...
        if (mshr_valid_debug[1] &&
            ...
            $display(
                "PASS: MSHR 1 and MSHR 3 remain active"
            );
        ...
        $display("");
        $display("TEST 6: Reuse released MSHR 0");
        $display("Expected: address 0x40 -> MSHR 0");
        ...
        $display("");
        $display("TEST 7: Verify existing MSHRs preserved");
        ...
        $display("");
        $display("TEST 8: Complete MSHR 3");
        $display("Expected: 0x30 -> AAAAAAAA");
        ...
        if (!mshr_valid_debug[3] &&
            ...
            $display(
                "PASS: MSHR 3 released while 0x40 and 0x10 remain"
            );
        ...
        $display("");
        $display("TEST 9: Reuse released MSHR 3");
        $display("Expected: address 0x50 -> MSHR 3");
        ...
        $display("");
        $display("TEST 10: Complete reused MSHR 3 first");
        ...
        if (!mshr_valid_debug[3] &&
            ...
            $display(
                "PASS: reused MSHR 3 completed first"
            );
            ...
            $display(
                "FAIL: reused MSHR 3 completion failed"
            );
        ...
        $display("");
        $display("TEST 11: Complete reused MSHR 0");
        ...
        if (!mshr_valid_debug[0] &&
            ...
            $display(
                "FAIL: reused MSHR 0 completion failed"
            );
        ...
        $display("");
        $display("TEST 12: Complete original MSHR 1");
        ...
        if (mshr_valid_debug == 4'b0000) begin
            ...
            $display(
                "PASS: all outstanding MSHRs released"
            );
         ...
         * ========================================================
         *
         * 0x20 was originally mapped to index 2 and was never
         * replaced, so it must remain a hit.
         */

        $display("");
        $display("TEST 13: Verify surviving cache line 0x20");
        ...
        if (resp_valid &&
            ...
            $display(
                "PASS: 0x20 surviving cache line correct"
            );
         ...
         * ========================================================
         *
         * 0x30 was originally mapped to index 3.
         * 0x50 uses index 1, so 0x30 remains independent.
         */

        $display("");
        $display("TEST 14: Verify surviving cache line 0x30");
        ...
        if (resp_valid &&
            ...
            $display(
                "PASS: 0x30 surviving write-miss line correct"
            );
         ...
         * ========================================================
         *
         * 0x40 maps to index 0.
         * It replaced the original 0x00 line.
         */
         ...
         * ========================================================
         *
         * 0x50 maps to index 1.
         * It replaced the original 0x10 line.
         */
         ...
         * ========================================================
         *
         * 0x00 maps to index 0.
         * 0x40 currently occupies index 0.
         *
         * Therefore 0x00 MUST MISS.
         */

        $display("");
        $display("TEST 17: Verify 0x00 was replaced by 0x40");
        $display("Expected: MISS + new MSHR allocation");
        ...
        if (mshr_valid_debug != 4'b0000 &&
            mshr_addr_debug[mshr_alloc_index] == 32'h00000000) begin
            ...
            $display(
                "FAIL: 0x00 replacement miss not allocated"
            );
         ...
         * 0x50 currently occupies index 1.
         *
         * Therefore 0x10 MUST MISS.
         */

        $display("");
        $display("TEST 18: Verify 0x10 was replaced by 0x50");
        $display("Expected: MISS + new MSHR allocation");
        ...
        if (mshr_valid_debug != 4'b0000 &&
            mshr_addr_debug[mshr_alloc_index] == 32'h00000010) begin
            ...
            $display(
                "FAIL: 0x10 replacement miss not allocated"
            );
         ...
         * ========================================================
         *
         * After refilling 0x00 and 0x10, the final direct-mapped
         * cache layout is:
         *
         *   index 0 -> 0x00
         *   index 1 -> 0x10
